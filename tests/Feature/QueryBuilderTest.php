...
class QueryBuilderTest extends TestCase
{
    ...
    {
        $this->db = new QueryBuilder(new PDO('sqlite:testing.sqlite3'));
    ...
    {
        $result = $this->db->testing()->from('mytable')->all();
    ...
    {
        $result = $this->db->testing()->select('id', 'name')
            ->from('mytable')
            ->groupBy('id', 'name')
            ->get();
    ...
    {
        $result = $this->db->testing()->table('mytable')->create([
    ...
    {
        $result = $this->db->testing()->table('mytb')->where('id', 3)->delete();
    ...
    {
        $result = $this->db->testing()->from('mytb')->limit(2)->get();
    ...
    {
        $result = $this->db->testing()->from('mytb')->count();
    ...
    {
        $result = $this->db->testing()->from('mytb')->first();
